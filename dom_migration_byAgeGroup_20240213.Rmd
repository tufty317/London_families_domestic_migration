...
ggsave (filename = (paste0(chart_dir, "DomMig_Net_flows_age_group_update.png")),
...
Net_flows_2022 <- 
  ...
  scale_color_manual(name="Flow direction:", values=c('#6da7de','#d82222','#eb861e'), guide="none") +
    labs(title= "Net domestic migration in 2022 by age of children, London", 
       caption = paste0(""))
Net_flows_2022

ggsave (filename = (paste0(chart_dir, "DomMig_net_flows_2022.png")),
         plot = Net_flows_2022,
         device = "png",
         dpi=600,
         width = 9,
