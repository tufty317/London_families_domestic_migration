...
Net_flows_4yo <- 
  ...
  scale_x_continuous(limits = c (2001, 2025), breaks = c (2001, 2005, 2009, 2013, 2017, 2020)) +  #set breaks on x-axis
  scale_color_manual(name="Flow direction:", values=c('#6da7de','#d82222','#eb861e'), guide="none") +
  labs(title= 'Net domestic migration, for four year old children, London, 2001 - 2020', 
       caption = paste0(""))
Net_flows_4yo
...
Net_flows_2020 <- 
   ...
   geom_line(data = UK_OuterLondon_net, aes(x = age, y = net_UKOuter/1000, colour = '#6da7de',
                                            label = paste("Age  :", age,
                             "<br>Outer London and rest of UK",
  ...
  scale_x_continuous(limits = c (0, 25), breaks = c (0, 5, 10, 15)) +  #set breaks on x-axis
  scale_color_manual(name="", values=c('#6da7de','#d82222','#eb861e'), guide="none") +
    labs(title= "Net domestic migration in 2020 by flow path, London", 
       caption = paste0(""))
Net_flows_2020
