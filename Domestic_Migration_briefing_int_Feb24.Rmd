...
31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602  
...
The report is intended as a resource for those working in sectors needing a perspective on population change in London. Our goal is to inform and assist a wide range of users -- for this, we depend on your feedback so please send your comments and suggestions to [demography\@london.gov.uk](mailto:demography@london.gov.uk){.email}.
...
# Interactive chart of in, out and net migration for London, 2002 - 2022. Uses Wil's code from chart club
...
```{r fig_London_domMig_1B, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}

# chart with no y axis title for families report
...
```{r fig_London_domMig_1BB, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}

# chart with no y axis title for families report, static version

london_longit_net_long  <- london_longit_net_wide2 %>% 
  mutate(sumvalue_in = sumvalue_inK*1000) %>% 
  mutate(sumvalue_out = sumvalue_outK*1000) %>% 
  mutate(sumvalue_net = sumvalue_netK*1000) %>%
...
london_longit_only_net  <- london_longit_net_long %>% 
  filter(Variable == "sumvalue_netK") %>%
  mutate(Direction= recode(Variable, "sumvalue_netK"="Net domestic migration")) %>%
  data.frame()

london_longit_inandout  <- london_longit_net_long %>%
  subset(Variable == "sumvalue_outK" | Variable == "sumvalue_inK") %>%
  mutate(Direction= recode(Variable, "sumvalue_outK"="Migration from London", 
                           "sumvalue_inK"="Migration to London")) %>%
  data.frame()
...
london_longit_net_static <- london_longit_inandout %>%
  ...
  scale_x_continuous(limits = c (2001, 2023), breaks = c (2002, 2006, 2010, 2014, 2018, 2022)) +
   scale_y_continuous(limits = c (-200, 1050), breaks = c (-200, 0, 200, 400, 600, 800, 1000)) +
...
ggsave (filename = "C:/Families/Charts_for_Daryl/22_B_dom_mig_longit_net_updated.svg",
...
###  {.unnumbered .leave-tabset}

##  {.unnumbered .toc-ignore .unlisted .unnumbered}
...
While there are many factors at play contributing to the variation in migration rate by age, the most important push factors for the 25 - 44 year group is likely to be the high cost of housing in London and limited availability of larger housing for families, and an important pull factor is the desire for a cleaner and greener environment. <br />
...
The map above shows that Brent, Newham and Haringey had the largest percentage net domestic migration out-flow. All three boroughs lost more than 2% of their population in the year ending June 2020 to boroughs outside London. Only the borough of Sutton gained population from outside London. <br />
...
31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602  
